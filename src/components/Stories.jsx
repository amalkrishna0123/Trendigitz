...
import { FaHeart, FaRegClock, FaHashtag } from "react-icons/fa";
                ...
                <SplideSlide key={i} className='mb-0.5'>
                  <div className=' relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200'>
                    ...
                    <div className=' flex items-center justify-between w-full px-4'>
                      <div className='flex items-center gap-0.5'><FaHeart className='icon-style text-red-500 w-5 h-5' /><span className='text-xs font-bold'>{val.like}</span></div>
                      <div className='flex items-center gap-0.5'><FaRegClock className='icon-style w-4 h-4 text-black' /><span className=' text-xs font-bold'>{val.time}</span></div>
