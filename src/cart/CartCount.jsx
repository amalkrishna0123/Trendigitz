      ...
      <div className=" bg-white h-11 flex items-center justify-between px-3 sticky top-0 left-0 right-0 w-full">
        <div className=" flex items-center gap-3">
          <div className="grid items-center cursor-pointer" onClick={onCartToggle}>
            <MdKeyboardDoubleArrowLeft className=" w-5 h-5 text-slate-900 hover:text-orange-500 strok-[2]" />
          </div>
        ...
        <div className=" flex items-center">
            <button type="button" onClick={onClearCartItems} className=" rounded bg-theme-cart active:scale-90 p-0.5 text-white"><IoClose className=" w-5 h-5"/></button>
        </div>
      </div>
    </>
  );
